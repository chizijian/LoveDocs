...
public class MainListAdapter extends BaseAdapter {
    ...
    public class StartUpdateEvent {
        ...
        public StartUpdateEvent(int position) {
    ...
    public MainListAdapter(Context context) {
        ...
        this.rotation = new RotateAnimation(0.0f, ROTATE_TO, 1, 0.5f, 1, 0.5f);
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (docsetVersion.getDocset().getIcon() != 0) {
            ...
            holder.docsetIcon.setImageDrawable(this.mRes.getDrawable(docsetVersion.getDocset().getIcon()));
        } else {
